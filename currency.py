...
def getHist(today):
    ...
    for i in range(7):
        ...
        hist['USD'].insert(0,rate['data']['USD']['value'])
        hist['EUR'].insert(0, rate['data']['EUR']['value'])
    return hist
...
def main():
    ...
    #Example data
##    data = {'Date': ['2023-11-04', '2023-11-09', '2023-11-14', '2023-11-19', '2023-11-24', '2023-11-29', '2023-12-03'],
##    'USD': [1.2375163123, 1.2216871693, 1.249234694, 1.2451747705, 1.2604457551, 1.2693896922, 1.2715041358],
##    'EUR': [1.1527342115, 1.1451242008, 1.1479968824, 1.1417755913, 1.1520601554, 1.1566933975, 1.1674444161]}
    ...
    ax.plot(x, y1, color='red', label='USD')
    ax.plot(x, y2, color='blue', label='EUR')
